...
CLANG="neutron"
TC_BRANCH="master"
TC_DIR="$HOME/kernel/clang-$CLANG"

AK3_URL="https://github.com/travarilo/AnyKernel3.git"
AK3_BRANCH="master"
AK3_DIR="$HOME/kernel/anykernel"
...
ZIPNAME="XilithKernel-$(git describe --abbrev=0 --tags)-$(date '+%Y%m%d-%H%M').zip"
export PROC="-j8"
...
# Make out folder
mkdir -p $HOME/kernel/kernel-out
